 ...
 */
namespace Envalo\EditOrder\Block\Adminhtml\Order\Create\Form;
...
class Address extends \Magento\Sales\Block\Adminhtml\Order\Create\Form\AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $helper = ObjectManager::getInstance()->get(\Envalo\EditOrder\Helper\Data::class);
        if(!$helper->isAllowedEdit()) {
            $fieldset->removeField('prefix');
            $fieldset->removeField('middlename');
            $fieldset->removeField('suffix');
            $fieldset->removeField('fax');
        }
